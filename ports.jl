...
ports = (   
    mus=(;
        major=(;
            ...
            Grand_River_North_West=(-20.171, 57.475),
            Mahebourg=(-20.405, 57.709),
            Port_Louie=(-20.1597, 57.5012),
            Tombeau_Bay=(-20.103544, 57.517389),
            Turtle_Bay=(-20.0834, 57.516),
        ),
        minor=(;
            Albion=(-20.218, 57.402),
            Bambous=(-20.349, 57.765), # From google maps
            Bel_Ombre=(-20.503, 57.399),
            Black_River=(-20.362, 57.372),
            Blue_Bay=(-20.443046, 57.716631), # From google maps
            Bois_des_Amorettes=(-20.368, 57.737), # From google maps
            Cap=(-19.986, 57.621),
            ...
            Petit_Sable=(-20.333, 57.771), # From google maps
            Point_aux_Feuilles=(-20.317, 57.774), # From google maps
            Poste_de_Flacq=(-20.163, 57.743),
            Poudre_de_Or=(-20.0610, 57.685),
            Quatre_Soeurs=(-20.301365, 57.778623), # Free google maps
            Riviere_des_Galets=(-20.501, 57.447),
            Riviere_du_Cap=(-20.493, 57.378),
            Riviere_du_Rampart=(-20.501, 57.447),
            Souillac=(-20.518, 57.517),
            Terre_Rouge=(-20.139, 57.499),
            Trou_dEau_Douce=(-20.244, 57.787),
            Ylang_Ylang=(-20.358, 57.751), # From google maps
        ),
    ),
    reu=(;
        major=(;
